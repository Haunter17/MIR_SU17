...
with tf.Session() as sess:
    ...
    train_err = cross_entropy.eval(feed_dict={x: X_train.reshape((-1, n_steps, n_input)), y: y_train})
    val_err = cross_entropy.eval(feed_dict={x: X_val.reshape((-1, n_steps, n_input)), y: y_val})
