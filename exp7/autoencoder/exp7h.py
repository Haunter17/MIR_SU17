...
# usage: python exp7h.py 64 0 0 0
# system arg
nhidden = 64
SMALL_FLAG = 1
FAST_FLAG = 1
...
# ==============================================
# ==============================================
print('==> Experiment 7h: Autoencoder hidden units...')
...
error = None
if SYS_FLAG:
	error = tf.reduce_mean(tf.square(x - h1))
else:
...
save_path = './out/7hmodel_{}.ckpt'.format(nhidden)
opt_val_err = np.inf
opt_epoch = -1
step_counter = 0
max_counter = 50
...
model_path = './out/7hmodel_{}'.format(nhidden)
