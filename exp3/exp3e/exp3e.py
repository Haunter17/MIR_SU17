...
trainingPlotTitles.append('Exp 3e, Validation Cross-Entropy Cost vs. Epoch')
trainingPlotFiles = ['exp3e_training_%gx%g_k1=%g_numHiddenUnits=%g_%gEpochs.png'%(filterRows[i], filterCols[i], k1s[i], numHiddenUnits, numEpochs) for i in range(len(filterRows))]
