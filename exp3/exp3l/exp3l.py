...
class Model:
	...
	def y_conv(self):
		...
		# group them into one layer
		h_grouped_flat = tf.concat([h_conv1_flat, h_conv2_flat], 1)

		print("shape of flat:")
		print(h_conv1_flat.get_shape())
		print(h_conv2_flat.get_shape())
		# softmax layer parameters
		self.W_sm = init_weight_variable([num_out_conv1 + num_out_conv2, self.num_classes], "W_sm")
		...
		y_conv = tf.matmul(h_grouped_flat, self.W_sm) + self.b_sm
