...
while ischar(curfile)
    ...
    [trainVec, validationVec, window_trainVec, window_validationVec] = createDataset(QMat, label, strideSize, num_frame_agg);
    ...
    window_testSet = cat(1, window_testSet, window_validationVec);
