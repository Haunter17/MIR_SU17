...
print('==> Experiment 8g - with dropout and batch normalization')
...
scipy.io.savemat('exp8g_db_weight.mat',saveweight)
...
scipy.io.savemat('exp8g_db_repNon.mat',repDict)