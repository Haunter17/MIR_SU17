...
#sess.run(y, feed_dict={x: X_train, y_: y_train})
#saver.save(sess, 'exp8a')
...
errfig.savefig('exp8a_relu_4000.png')
...
scipy.io.savemat('exp8a_relu_repNon.mat',repDict)
scipy.io.savemat('exp8a_relu_repRow.mat',repRowDict)
scipy.io.savemat('exp8a_relu_repZero.mat',repZeroDict)